...
private:
	...
	GLenum iPrimtive_pi2gl(PrimitiveType pt);
    bool iLoadFromFile(const wchar_t *file, unsigned int programID);
    bool iSaveToFile(const wchar_t *file, unsigned int programID);
