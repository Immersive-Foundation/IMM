...
#include "layerPaint/drawingPretessellated.h"
...
namespace ImmImporter
{
	...
	class LayerPaintPretessellated : public LayerPaint
	{
	public:
		LayerPaintPretessellated() = default;
		~LayerPaintPretessellated() = default;
	...
	private:
		// static data
		std::vector<DrawingPretessellated> mDrawings;
